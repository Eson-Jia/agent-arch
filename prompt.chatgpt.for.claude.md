阅读如下技术方案草稿，然后根据草稿，结合 https://github.com/spring-ai-alibaba/examples 中的示例代码，就在当前工程中生成示例(重在框架，所以有些现实逻辑直接用 mock)代码工程。你要输出的是 claude 的 prompt,从而让其在 examples 本地工程中生成一个新的 examples 但是符合如下草稿的基本要求：
# 思路文档
